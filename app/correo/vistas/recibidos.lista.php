...
$recib_row = $mcorreo->selectRecibidos();
...
<div class="row">
    ...
    <li class="">
      <a href="#" class="text-success" onclick="load('app/correo/vistas/admin.panel.php','enviado=0','#admin-panel'); return false;"><i class="fa fa-refresh"></i> Refrescar</a>
    </li>
	</ul>
</div>
