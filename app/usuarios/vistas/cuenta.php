...
$usua_row = $musuarios->selectIde($_SESSION['casicoin_usr']);
...
<div id="breadcrumbs" class="breadcrumbs">
	...
	<ul class="breadcrumb">
		...
		<li class="active"><i class="fa fa-user"></i> Cuenta de Usuario</li>
	</ul><!-- .breadcrumb -->		
</div>
...
<form action="" class="form-horizontal usuario-update">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<select disabled class="width-90 chosen-select uno" data-placeholder="Seleccione Departamento" name="">	
					<option value=""></option>
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<select disabled class="width-90 chosen-select dos" data-placeholder="Seleccione Función" name="">	
					<option value=""></option>
	...
	<input type="hidden" name="departamento" value="<?php echo $usua_row[0]->deide ?>">
	<input type="hidden" name="cargo" value="<?php echo $usua_row[0]->caide ?>">
</form>
